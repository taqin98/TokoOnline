...
<!-- Sidebar end=============================================== -->
	...
	<div class="row">	  
            ...
            <a href="themes/images/products/large/1.jpg" title="Code: 01.07.006.18">
				<img src="themes/images/products/large/1.jpg" style="width:100%" alt="Code: 01.07.006.18"/>
            </a>
			<div id="differentview" class="moreOptopm carousel slide">
                <div class="carousel-inner">
                  <div class="item active">
                   <a href="themes/images/products/large/1.jpg"> <img style="width:29%" src="themes/images/products/large/1.jpg" alt=""/></a>
                   <a href="themes/images/products/large/2.jpg"> <img style="width:29%" src="themes/images/products/large/2.jpg" alt=""/></a>
                  </div>
                  <div class="item">
                   <a href="themes/images/products/large/1.jpg"> <img style="width:29%" src="themes/images/products/large/1.jpg" alt=""/></a>
                   <a href="themes/images/products/large/2.jpg"> <img style="width:29%" src="themes/images/products/large/2.jpg" alt=""/></a>
			...
			<div class="span6">
				<h3>Code: 01.07.006.18 
				<br>"PICO"  </h3>
				<small>Short sleeve cotton t-shirt</small>
				<hr class="soft"/>
				<form class="form-horizontal qtyFrm">
				  <div class="control-group">
					<label class="control-label"><span>IDR 140.000</span></label>
					<div class="controls">
				...
				<p>
				Size chart
				<br>S: Length 70 x Width 50 cm
				<br>M: Length 72 x Width 52 cm
				<br>L: Length 74 x Width 54 cm
				<br>XL: Length 76 x Width 56 cm
            ...
            <div id="myTabContent" class="tab-content">
			  ...
			  <h4>Product Information</h4>
				...
				<tr class="techSpecRow"><td class="techSpecTD1">Brand: </td><td class="techSpecTD2">rown division</td></tr>
				<tr class="techSpecRow"><td class="techSpecTD1">Model:</td><td class="techSpecTD2">T-shirt</td></tr>
				<tr class="techSpecRow"><td class="techSpecTD1">Released on:</td><td class="techSpecTD2"> 2018-07-10</td></tr>
				<tr class="techSpecRow"><td class="techSpecTD1">Display size:</td><td class="techSpecTD2">Size chart
				<br>S: Length 70 x Width 50 cm
				<br>M: Length 72 x Width 52 cm
				<br>L: Length 74 x Width 54 cm
				<br>XL: Length 76 x Width 56 cm
